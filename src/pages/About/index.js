          ...
          <div className="top-section">
            <div className="left">
              ...
              <div className="about__info">
                <PText>
                  I'm from Sonora, Mexico. Graduated with a degree in systems
                  engineering. Since I started my professional journey as a
                  software developer 2 years ago, I've done remote work for
                  agencies, consulting for startups, and I've collaborated with
                  talented people to create digital products for both business
                  and consumer.
                  <br /> <br />
                  I am a self-confident, curious by nature, self-taught and
                  always working to improve my skills, learn new technologies,
                  and eager to work with new talented developers.
                  <br />
                  <br />I am passionate about finding new ways to solve current
                  needs, using the tools that new technologies provide us to
